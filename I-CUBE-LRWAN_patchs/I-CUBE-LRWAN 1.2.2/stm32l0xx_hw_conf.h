...
#ifdef RADIO_DIO_5 
//#define RADIO_DIO_5_PORT                          GPIOC 			/* unused on USI_I-NUCLEO-LRWAN1 Shell Board */
//#define RADIO_DIO_5_PIN                           GPIO_PIN_7  /* unused on USI_I-NUCLEO-LRWAN1 Shell Board */
#endif
...
#define RADIO_ANT_SWITCH_PORT2                    GPIOB
#define RADIO_ANT_SWITCH_PIN2                     GPIO_PIN_8
...
#define USARTx_TX_PIN                  GPIO_PIN_14	/* PA14 is the UART2-TX for debug on USI_I-NUCLEO-LRWAN1 Shell Board */
#define USARTx_TX_GPIO_PORT            GPIOA  
#define USARTx_TX_AF                   GPIO_AF4_USART2
#define USARTx_RX_PIN                  GPIO_PIN_1		/* UART2 is only for TX on USI_I-NUCLEO-LRWAN1 Shell Board, so this is a dummy setting */
